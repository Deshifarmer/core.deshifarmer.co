...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'delivery_address' => Employee::where('df_id', $this->distributor_id)->get()->implode('business_present_address'),
            'delivery_contact' => Employee::where('df_id', $this->distributor_id)->get()->implode('business_contact_no'),
